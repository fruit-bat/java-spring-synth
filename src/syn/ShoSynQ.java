...
public class ShoSynQ implements Syn {
	...
	public ShoSynQ() {
		for (int i = 0; i < 128; ++i) {
				...
				_shos[i * 3 + 0] = new SHO(f * 1.998, 0.008 );
				_shos[i * 3 + 1] = new SHO(f, 0.008 );
				_shos[i * 3 + 2] = new SHO(f * 4.001, 0.008 );
		}
	}
